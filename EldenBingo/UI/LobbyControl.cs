...
namespace EldenBingo.UI
{
    internal partial class LobbyControl : ClientUserControl
    {
        ...
        private PopoutBoardForm? _popoutBoardForm;
        ...
        public void OpenPopoutBoard()
        {
            if (_popoutBoardForm != null)
            {
                _popoutBoardForm.Activate();
                return;
            }

            _popoutBoardForm = new PopoutBoardForm
            {
                Client = Client,
            };
            _popoutBoardForm.FormClosed += (sender, args) =>
            {
                _bingoControl.ConnectClickHotkey();
                _popoutBoardForm = null;
            };
            _popoutBoardForm.Show();
        ...
        protected override void ClientChanged()
        {
            ...
            if (_popoutBoardForm != null)
            {
                _popoutBoardForm.Client = Client;
            }
